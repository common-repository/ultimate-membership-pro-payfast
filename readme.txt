...
Tags: Payment, Merchant, Transaction, Free, Member, Ultimate Membership Pro
...
== Description ==
**Makes it easier for visitors to become members by facilitating operations and one-time payments.**

With this plugin activated, processing payments will be incredibly simple and almost immediate.
...
This addon will be included in the list of payment channels offered by Ultimate Membership Pro. Users can acquire membership with this addon for those that do not demand recurring or trial payments.
**Keep in mind that this plugin only functions as a one-time payment. To operate subscriptions, you can check the PayFast Pro version.**

All you have to do is installation, activation, and setup of the extension.


### 💡 For PayFast to work, [Ultimate Membership Pro](https://ultimatemembershippro.com) is required.
...
- Or rate Ultimate Membership Pro - PayFast on WordPress
...
5. In [Ultimate Membership Pro](https://ultimatemembershippro.com) plugin dashboard go to navigation menu and find EXTENSIONS tab. Upon clicking the menu’s item, a box with PayFast module will be available.


## ✔️ COVERED BY A TRUSTED TEAM ##
Plugin Ultimate Membership Pro - PayFast is developed by [WPIndeed Development](https://wpindeed.com/), a dedicated WordPress product company with over 100k happy customers.

== Screenshots ==
1. Addon activated
2. Order from the list of payment tools
3. Payfast activated in Payment Services
...
**How do I suggest a new feature of Ultimate Membership Pro Addon - PayFast?**
For any suggestion of Ultimate Membership Pro Addon - PayFast you may open a ticket on [store.wpindeed.com](https://store.wpindeed.com/) after logging in, or leave a comment in [UltimateMembershipPro community](https://www.facebook.com/UltimateMembershipPro).

**Do I need skills to use Ultimate Membership Pro Addon - PayFast?**
